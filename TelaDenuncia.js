...
export default function TelaLogin() {
    ...
    const [modalEnviarVisible, setModalEnviarVisible] = useState(false);

    const navigation = useNavigation();

    const handleEnviarPress = () => {
        setModalEnviarVisible(true);
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.buttonSubmit} onPress={handleEnviarPress}>
            ...
            <Modal animationType='fade' transparent={true} visible={modalEnviarVisible}>
                <View style={styles.modalBackground}>
                    <View style={styles.modalContainer}>
                        <View style={styles.modalContainerEnviar}>
                            <Text style={styles.modalTextEnviar}>Obrigado! Denúncia eviada com sucesso!</Text>
                            <TouchableOpacity onPress={() => { handleNavegarHome(); }}>
                                <Text style={styles.modalTextFinalizar}>Finalizar</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
